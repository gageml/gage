//! Builder for the interactive `/gage:review` Claude Code session,
//! shared by `gage review` and the scan view's review action.
...
/// gage review skill, scoped to `issue_ids` (all pending and open
